   // Fetch stats and display them in the page.
    function fetchStats(){
      ...
      fetch(url).then((response) => {
        ...
        const longestMessageElement = buildStatElement('Longest Message Length (Characters): ' + stats.longestMessageLength);
        ...
        const topUsers = buildStatElement('Top Users: ' + (stats.topUser1  || '') + ', ' + (stats.topUser2  || '') + ', ' + 
            (stats.topUser3 || ''));
